  ...
  return (
    <section className="py-12 sm:py-16 lg:py-20 bg-gradient-to-b from-stone-900 to-amber-950">
      <div className="container mx-auto px-4">
        ...
        {/* Secondary Video - Clickable Thumbnail that plays Vimeo */}
        <div className="max-w-4xl mx-auto mb-8 sm:mb-12">
          <Card className="bg-stone-800/50 border-stone-700 overflow-hidden shadow-2xl">
            {!showVimeoVideo ? (
              <div className="aspect-video relative group cursor-pointer" onClick={handleThumbnailClick}>
                <img
              ...
              <div className="relative" style={{ padding: "153.33% 0 0 0", position: "relative" }}>
                <iframe 
                  src="https://player.vimeo.com/video/1100855873?badge=0&autopause=0&player_id=0&app_id=58479&autoplay=1" 
                  frameBorder="0" 
                  allow="autoplay; fullscreen; picture-in-picture; clipboard-write; encrypted-media; web-share" 
                  style={{ position: "absolute", top: 0, left: 0, width: "100%", height: "100%" }}
